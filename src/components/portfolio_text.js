...
export default {
  one: {
    ...
    description: 'Whether you\'re looking to identify unhealthy triggers in your life, trying to make sense of hormonal cycles, or simply looking for a unique way to journal, Moodoo\'s color-coded visuals help the user see trends in their moods over time.',
    stack: {
      front: ['React', 'Redux'],
    ...
    role: 'I built this project myself, from scratch, in order to practice using React & Redux as well as NodeJS, Express, and PostgreSQL. A minimal amount of back-end code was recycled from an earlier pair project.',
    whatILearned: ''
  },
  two: {
    img: {
  ...
  three: {
    ...
    description: 'Localize springs from my own frustration with the lack of a go-to app for authentic, live-like-a-local travel. Localize seeks to capture the experience of getting personalized recommendations from a local friend — the person who\'s lived in a city for years and knows the romantic tucked-away parks, the best days to go to the local independent movie theater, and that hole-in-the-wall with great ramen.',
    stack: {
      front: ['React', 'Redux'],
      back: ['Node.js', 'Express'],
      db: ['PostgreSQL']
